...
<nav class="bg-white/50 backdrop-blur-sm fixed top-0 z-50 w-full" x-data="{ mobileOpen: false }">
    <div class="relative max-w-7xl mx-auto px-4">
        ...
        <div class="flex items-center justify-between h-20 lg:h-24">
            ...
            <div class="flex-shrink-0">
                <a href="/" aria-current="page">
                    <img src="/asset/BYS_LOGO.png" class="h-8 lg:h-10 w-auto" alt="UCEAI Logo">
                </a>
            </div>

            <!-- Desktop Main Menu -->
            <div class="hidden lg:flex items-center space-x-12 text-sm font-semibold text-gray-700 mt-10">
        ...
        <div class="hidden lg:block absolute top-0 right-4 h-10 bg-red-700 rounded-bl-lg">
