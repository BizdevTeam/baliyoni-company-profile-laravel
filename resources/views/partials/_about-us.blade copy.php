            ...
            <div class="relative z-10">
                <div id="image-slider-container" class="w-[700px] h-[650px] bg-white rounded-2xl overflow-hidden shadow-lg flex flex-col">
                    ...
                    <div class="h-1/2 w-full">
                        ...
                        <img id="image-slider-1" src="" alt="Gambar Tentang Kami 1" class="w-full h-full object-cover transition-opacity duration-50 ease-in-out">
                    </div>
                    
                    <div class="h-1/2 w-full">
                        {{-- Beri ID unik untuk gambar kedua --}}
                        <img id="image-slider-2" src="" alt="Gambar Tentang Kami 2" class="w-full h-full object-cover transition-opacity duration-50 ease-in-out">
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateImages() {
            ...
            }, 50); // Durasi ini harus cocok dengan `duration-1000` di kelas CSS
        }
